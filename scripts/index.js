...
const profilePopupCloseButton = document.querySelector('.profile_close');
const cardPopupCloseButton = document.querySelector('.card_close');
const picturePopupCloseButton = document.querySelector('.picture_close');
